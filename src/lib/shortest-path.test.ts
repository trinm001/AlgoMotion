...
describe("shortest path engines", () => {
  ...
  it("detects a reachable negative cycle", () => {
    const graph = parseGraph(3, "0 1 1\n1 2 -2\n2 1 -2", { weighted: true, directed: true });
